...
REASON="NUDGE: Code changed without doc updates. Re-verify the 'Done' Definition, 'Task Gate' Protocol, and Architecture Sync in GEMINI.md, ARCHITECTURE.md, tech-stack.md and CHANGELOG.md before finishing. If no update is needed, state 'no update needed' to proceed."
