...
4. **Compile Feedback:** Write all findings to a new file named `REVIEW_FEEDBACK.md`. Use the strict markdown format required by `reviewer.md`. If no issues are found in a file, do not list it.
