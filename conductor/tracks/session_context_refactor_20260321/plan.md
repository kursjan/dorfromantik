...
- [ ] Create `src/models/HistorySyncSession.test.tsx` (or similar) lightweight integration test for real-time history sync using **task-conductor** skill.
- [ ] Create `e2e/history-sync.spec.ts` for E2E testing of the real-time history sync using **task-conductor** skill.
